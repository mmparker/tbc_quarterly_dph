...
# Identify the most recently completed quarter
...
actives <- query_actives(start_date = last.qtr$start.date,
...
visits <- query_visits(start_date = last.qtr$start.date,
                       stop_date = last.qtr$end.date)
...
tests <- query_tests(start_date = last.qtr$start.date,
                     stop_date = last.qtr$end.date)
...
# 
plans <- query_tx_plans(start_date = last.qtr$start.date,
                        stop_date = last.qtr$end.date)
